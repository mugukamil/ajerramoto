<!-- Header - Category/Product Pages (Dark variant) -->
<header class="header header-dark" id="header">
  <div class="container">
    <a href="index.php" class="logo">AJERRA</a>
    <nav class="nav">
      <a href="index.php#models" class="nav-link">Модели</a>
      <a href="category.php" class="nav-link active">Запчасти</a>
    ...
    <div class="header-actions">
      ...
      <button class="icon-btn icon-btn-heart" aria-label="Избранное">
